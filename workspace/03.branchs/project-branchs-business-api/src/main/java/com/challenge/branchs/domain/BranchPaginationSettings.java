...
public record BranchPaginationSettings(
        ...
        @Nullable @Pattern(regexp = "branchId|branchName|branchCity|branchState")
        String page_sort_field,

        @Nullable @Pattern(regexp = "ASC|DESC")
        String page_sort_order
) {
    public static Pageable PaginationSettingsTemplate(BranchPaginationSettings pageSettings, String fixField) {
        return PageRequest
