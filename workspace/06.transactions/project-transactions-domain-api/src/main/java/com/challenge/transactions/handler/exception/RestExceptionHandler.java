package com.challenge.transactions.handler.exception;

import com.challenge.transactions.handler.domain.BadResponseTemplate;
import com.challenge.transactions.handler.domain.GenericErrorResponseTemplate;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity handleException(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.badRequest().body(
            new BadResponseTemplate(
                        HttpStatus.BAD_REQUEST,
                        "O payload é inválido. Verifique o(s) erro(s) apresentados no campo 'message'.",
    ...
    public ResponseEntity handleException(BadRequestException ex) {
        ...
        return ResponseEntity.badRequest().body(new BadResponseTemplate(
                HttpStatus.BAD_REQUEST,
                "O payload ou o request é inválido. Verifique o(s) erro(s) apresentado(s) no campo 'message'.",
                ex.getMessage()));
    }
    /* ------------------------------------------------------------------------ */
