...
public record TransactionPaginationSettings(
        ...
        @Nullable @Pattern(regexp = "transactionId|accountIdOrigin|transactionStatus|transactionIdDestination")
        String page_sort_field,

        @Nullable @Pattern(regexp = "ASC|DESC")
        String page_sort_order
) {
    public static Pageable PaginationSettingsTemplate(TransactionPaginationSettings pageSettings, String fixField) {
        return PageRequest
